export function schedaGlobaleImport() {
  ...
  d3.text(`/vini/listone.csv`).then(function(data) {
      ...
      for (const i of composizioneArray) {
        ...
        function nationCheck(){switch(cleanVitigno){case"cabernet-sauvignon":case"cabernet-franc":case"carmenere":return"Francia";case"pinot-nero":return"Francia";default:return"Italia"}}
